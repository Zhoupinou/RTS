...
public class BuildingManager : MonoBehaviour
{
    ...
    {   
        ...
        if (buildingToBuild.name == "KingSlime")
        {
            // vérifiez si vous avez suffisamment de ressources pour construire le 'KingSlime'
            if (gameManager.iron < 5 || gameManager.gold < 5 || gameManager.wood < 5)
            {
                Debug.Log("Pas assez de ressources pour construire le KingSlime !");
                return;
            }
        ...
        if (buildingToBuild.name == "Boucherie")
        {
            // vérifiez si vous avez suffisamment de ressources pour construire le 'Market'
            if (gameManager.iron < 1 || gameManager.wood < 1)
            {
                Debug.Log("Pas assez de ressources pour construire le Boucherie !");
                return;
            }
